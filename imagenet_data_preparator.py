...
import params
# from statistics_todelete import get_imagenet_distributions
import math

class ImagenetDataPreparator:
    def __init__(self):

        # dodaj nazwe wszedzie, zeby bylo need to generate imagenet tf records itp
        # todo wylacz parametry z decode do paramsow
        # zrob jakies ladne, wspolne sciezki
        # zrob generalny mkdir a nie tak wszedzie w kodzie sie to wala - najlepiej w base
        # przenies imagenet utils do preparatora
        # zrob jakies ladne, wspolne statystyki
        # rename base preparator i plik z base preparatorem
        # todo wywal nazwy modeli do paramsow
        # zmien val w tf recordach na validation
        # todo dodaj pobieranie yolo wag
        # wywal plik statistics
        # przenies num_batches do wspolnego
        # przenies create recorde do wspolnego
        # przenies image read do wspolnego
        # przenies parse xml do wspolnego
        # wywal dane do internetu, zeby w razie czego mozna bylo pobrac
    ...
    def create_classification_data(self):
        # todo zmien zeby nie sprawdzalo, czy jest folder, tylko czy sa w nim pliki
