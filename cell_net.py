...
from cell_net_utils import possibly_create_dirs, decode_train_data, \
    get_bounding_boxes, remove_outliers, draw_bounding_boxes, colours, draw_predicted_cells, image_read, resize_label, create_augmented_tf_records
...
model_to_save_path = 'models/cell_network_14_03_eta0_00001_adam_50epochs_batch10_s14'
pretrained_model_path = None

t_images_path = 'data/train_images/'
t_labels_path = 'data/train_labels/'
v_images_path = 'data/val_images/'
v_labels_path = 'data/val_labels/'
train_records_path = 'data/train_records/'
embedded_images_path = 'data/output_images/'
